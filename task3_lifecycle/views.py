...
from task3_lifecycle.serializers import (
...
def _build_manifest_from_upload(*, payload: dict[str, Any], artifact_path: str, checksum: str) -> dict[str, Any]:
    ...
    return {
        ...
        "entrypoint": "task2_quality.runtime:run_quality_inference",
        "artifacts": [
            {
                "type": "model_weights",
                "path": artifact_path,
...
class LifecycleModelListView(APIView):
...
class LifecycleModelUploadView(APIView):
    authentication_classes = []
    permission_classes = []
...
class LifecycleModelActivateView(APIView):
    authentication_classes = []
    permission_classes = []
...
class LifecycleModelRollbackView(APIView):
    authentication_classes = []
    permission_classes = []
