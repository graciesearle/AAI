...
from task1.task1_recommendation.runtime import build_recommendations
from task1.task1_recommendation.serializers import (
    RecommendationRequestSerializer,
    RecommendationResponseSerializer,
)


class RecommendationAdapterView(APIView):
