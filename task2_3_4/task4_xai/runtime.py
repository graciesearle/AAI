...
def build_explanation(*, image_file, checkpoint_path, model_name, model_version, context=None, manifest=None, methods=None, device=None) -> dict[str, Any]:
    """
    ...
    report_img = xai.generate_master_audit_report(image_file, selected_methods = methods)
